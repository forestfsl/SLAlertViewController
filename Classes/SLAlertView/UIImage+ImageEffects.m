...
#warning if you don't understand,please check out the official documents

#import "UIImage+ImageEffects.h"
@import Accelerate;//等价于#import <Accelerate/Accelerate.h>
...
{
    //currentView create a bitmap based graphics context,and make size
    UIGraphicsBeginImageContextWithOptions(view.bounds.size, YES, [UIScreen mainScreen].scale);
    //renderInContext 渲染指定内容到上下文
    [view drawViewHierarchyInRect:view.bounds afterScreenUpdates:NO];
    //Return a picture based on the current graphics context
